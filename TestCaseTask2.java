...
public class TestCaseTask2 {
	...
	public void testInitCustomer() {
		customerData = DataManagement.initCustomer(this.CUSTOMER_FILE);
	...
	public void testInitStock() {
		stockData = DataManagement.initStock(this.STOCK_FILE);
	...
	public void testInitWallet() {
		walletData = DataManagement.initWallet(this.WALLET_FILE);
